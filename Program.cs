//Rongta RPP320
//Rongta Termal yazıcı ya bulk transfer ile veri gönderimi
//Üreticinin sürücüleri veya 3prt bir sürücü/kütüphane kullanılmadan
//direkt Windows API leri üzerinde veri gönderilecektir.
...
namespace UsbTest_WinAPI
{
    class Program
    {
        static void Main()
        {
            ...
            4817b6d: Cihazın belirli oturumdaki "instance" kimliğidir. USB port değiştiğinde, tak çıkart vs.. durumlarda değişebilir
            0&2: Fiziksel bağlantının yerini tanımlayan bir alt bilgi
            GUID ise USB cihazları için kullanılan bir arayüz sınıfını temsil ediyor. Aşağıki adreslerde detay var
              Bu bilgiler büyük/küçük harf duyarlı değil.
            */

            //her iki tanımlada erişim oluyor, fakat teknik dokümanlar
            ...
            //Bu veriyi devicePath'a aktarırken \ -> # değişimi yapılmalı ve diğer kısımlar aynen kalmalı!
            #endregion
